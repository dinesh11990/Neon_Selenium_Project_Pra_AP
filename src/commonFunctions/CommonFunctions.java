...
public class CommonFunctions {
	...
	//We call it as Factory Design Pattern (Creating object without new)
...
FileInputStream fileInputSteam = new FileInputStream("config.properties");
...
/*-------------------------------------------------------------------*/
	...
	public void launchBrowser() throws IOException{
		...
		//Step-1: Configurating the Log4j properties
